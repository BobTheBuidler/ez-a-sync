...
class TestClass(ASyncBase):
    ...
    async def test_fn(self) -> int:
        ...
        assert TestClass.test_fn.__is_async_def__ is True, f"{TestClass.test_fn.__is_async_def__} is not True"
        return self.v
...
class TestSync(ASyncBase):
    ...
    def test_fn(self) -> int:
        ...
        assert TestSync.test_fn.__is_async_def__ is False, f"{TestSync.test_fn.__is_async_def__} is not False"
        return self.v
