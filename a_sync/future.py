...
class ASyncFuture(concurrent.futures.Future, Awaitable[T]):
    ...
    Attributes:
        __awaitable__ (Awaitable[T]): The awaitable object.
        __dependencies (List[ASyncFuture]): A list of dependencies.
        __dependants (List[ASyncFuture]): A list of dependants.
        __task (asyncio.Task[T]): The task associated with the awaitable.
    """
...
class _ASyncFutureInstanceMethod(Generic[I, P, T]):
    ...
    Attributes:
        __module__ (str): The module name of the wrapper.
        __name__ (str): The name of the wrapper.
        __qualname__ (str): The qualified name of the wrapper.
        __doc__ (str): The docstring of the wrapper.
        __annotations__ (dict): The annotations of the wrapper.
        __dict__ (dict): The dictionary of the wrapper.
        __instance (I): The instance to which the method is bound.
        __wrapper (_ASyncFutureWrappedFn[P, T]): The wrapper function.
    """
    def __init__(
        self,
