...
def as_completed(
    ...
    **tqdm_kwargs: Any
    ...
    Returns:
        An iterator of coroutines that yield each completed result.
...
def as_completed(
    ...
    **tqdm_kwargs: Any
    ...
    Returns:
        An async iterator that yields each completed result.
...
def as_completed(
    ...
    **tqdm_kwargs: Any
    ...
    Returns:
        An iterator of coroutines that yield each completed (key, value) pair.
...
def as_completed(
    ...
    **tqdm_kwargs: Any
    ...
    Returns:
        An async iterator that yields each completed (key, value) pair.
