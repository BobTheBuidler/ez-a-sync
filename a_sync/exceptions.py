"""
This module defines custom exceptions for the a_sync library, which are used to handle various error conditions related to asynchronous operations and flag handling.
"""
...
class KwargsUnsupportedError(ValueError):
    """
    Raised when keyword arguments are not supported for an operation.
    """
    def __init__(self):
        """
        Initializes the KwargsUnsupportedError exception.
        """
